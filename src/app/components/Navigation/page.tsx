...
export  default function Navigation() {
  ...
  return(
    <nav >
      <div className="flex flex-row align-center justify-end p-10" >
        <div className="flex justify-center items-center gap-96 border border-solid border-purple-nav pl-5 pr-5 rounded-lg h-10 bg-purple-nav">
            ...
            <div className="flex justify-center items-center gap-3 ml-48"> 
              <Link href="/home" className="flex gap-1 cursor-pointer text-zinc-200  hover:text-purple" >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-home"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                ...
                <Link href="/AboutMe" className="flex gap-1 cursor-pointer text-zinc-200 hover:text-purple">
                ...
                <Link href="/Skills" className="flex gap-1 cursor-pointer text-zinc-200 hover:text-purple">
                ...
                <Link href="/Carrer" className="flex gap-1 cursor-pointer text-zinc-200 hover:text-purple">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-briefcase"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
                  Career
                </Link>
                <Link href="/ProjectsPage" className="flex gap-1 cursor-pointer text-zinc-200 hover:text-purple">
                ...
                <Link href="/Contact" className="flex gap-1 cursor-pointer text-zinc-200 hover:text-purple">
